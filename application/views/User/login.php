...
<section class="login-area pt-80px pb-80px position-relative">
    ...
    <div class="container">
                ...
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            <h3 class="fs-22 pb-3 fw-bold">Log in to M-A-O</h3>
                            <div class="divider"><span></span></div>
                            <p class="pt-3">Enter your email address and login to your account.</p>
                        </div>
                        <?php if($this->session->tempdata('login_failed',3)) : ?>
                        <?= '<p class="alert alert-danger">'.$this->session->tempdata('login_failed',3).'</p>'?>
                        <?php endif;?>
                        <?= validation_errors();?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control form--control" placeholder="Email address" >
                        </div><!-- end form-group -->
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18">Password</label>
                            <div class="input-group">
                                <input class="form-control form--control password-field" id="password" type="password" name="password" placeholder="Password" autocomplete="off">
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?=base_url()?>Forgot-Password" class="btn-text fs-14 hover-underline fw-regular">Forgot Password?</a>
                        </div><!-- end form-group -->
                        <div class="form-group">
        ...
        <p class="text-black text-center fs-15">Don't have an account? <a href="<?=base_url()?>Signup" class="text-color hover-underline">Sign up</a></p>
    </div><!-- end container -->
</section>
<!--======================================
        END LOGIN AREA
