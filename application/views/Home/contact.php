...
<section class="hero-area bg-white shadow-sm pt-80px pb-80px">
    ...
    <div class="container">
        <div class="hero-content text-center">
            ...
            <br> Please, feel free to let us know anything you have in your mind.<br>
            <?php foreach($respo as $row){?>
                <strong>We typically reply <?php echo $row['response'];?>.</strong>
            <?php }?>
            </p>
...
<!--======================================
        START CONTACT AREA
======================================-->
<section class="contact-area pt-80px pb-80px" style="background-color: hsl(120, 60%, 70%, 0.3);">
    <div class="container">
    <?=form_open(base_url().'Email_controller/contactus')?>
        <div class="contact-form card card-item">
            <div class="card-body row">
                <div class="col-lg-7">
                    ...
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-20">Subject</label>
                        <input type="text" id="subject" name="subject" class="form-control form--control fs-14" placeholder="What is this about">
                    </div><!-- end form-group -->
                    <div class="form-group">
                ...
                <div class="col-lg-5">
                    <div class="contact-information-wrap pl-4 border-left border-left-gray h-100">
                        ...
                        <p class="pt-3 pb-5">Or you can contact us using the contact information below.</p>
