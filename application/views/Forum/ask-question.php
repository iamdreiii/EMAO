        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-item">
                    <form method="post" action="<?=base_url()?>/Forum_controller/postquestion" class="card-body">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="topic" placeholder="e.g. best way to breed cows?">
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Forums</label>
                            <p class="fs-13 pb-3 lh-20">Please choose the appropriate forum section so the question can be searched easily.</p>
                            <div class="form-group">
                                <select class="select-container select--container" data-placeholder="Select a Forum" name="forum">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <textarea class="form-control form--control user-text-editor" rows="10" cols="40" name="description"></textarea>
                        ...
                        <div class="input-box pt-2">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox fs-13">
                                    ...
                                    <label class="custom-control-label custom--control-label" for="youAgreeCheckBox">By asking your question, you agree to the <a href="<?=base_url()?>Privacy-Policy" class="text-color hover-underline">Privacy Policy.</a></label>
                                </div>
                            </div>
                            <div class="btn-box">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet-2 fs-14">
                                            ...
                                            <li class="lh-18 text-black-50 mb-0">Include any details</li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- end card -->
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <button class="btn btn-link collapsed fs-15" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <span><span class="text-color pr-2 fs-16">3.</span> Describe some examples</span>
                                        <i class="la la-angle-down collapse-icon"></i>
                                    </button>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body">
                                       <p class="fs-14 lh-22 text-black-50">
                                           When appropriate, share examples that you encounter</p>
                                    </div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end accordion -->
